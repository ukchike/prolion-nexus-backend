...
const PLANS = {
  ...
  starter: {
    ...
    limits: { companies: 1, users: 2, bank_statements: 5, ai_credits: 150 },
    features: {
  ...
  growth: {
    ...
    priceMonthly: 15000, priceAnnual: 150000,
    limits: { companies: 1, users: 5, bank_statements: 20, ai_credits: 500 },
    features: {
      sales: true, purchases: true, reconciliation: true, nrsVatExport: true,
      statementExport: true, aiAssistant: true, emailInvoices: true, auditTrail: true,
